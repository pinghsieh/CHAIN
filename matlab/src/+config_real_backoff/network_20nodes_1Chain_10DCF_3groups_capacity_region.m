...
N_per_CHAIN_group = round(N_CHAIN_node/2);
...
arrival_rate_group1 = rho1*ones(N_per_CHAIN_group, 1);
arrival_rate_group2 = rho2*ones(N_per_CHAIN_group, 1);
arrival_rate_group3 = 10/100*ones(N_DCF, 1);
