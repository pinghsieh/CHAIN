...
%rho_vec = [0.006 0.0055 0.005 0.0045 0.004 0.0035 0.003 0.0025 0.002];
%rho_vec = [0.0055 0.006];
%rho_vec = [0.0005 0.001 0.0015 0.002 0.0025 0.003 0.0035 0.0036];
rho_vec = [0.0005 0.001 0.0015 0.002 0.0025 0.003 0.0035 0.004 0.0045 0.0055];
%network_config_code = '2-1-0-0-1group';
%network_config_code = '3-1-0-0-1group';
%network_config_code = '10-1-0-0-1group';
%network_config_code = '10-1-0-0-10groups-het';
%network_config_code = '20-1-10-2groups-het';
%network_config_code = '500-1-0-0-1group';
network_config_code = '500-1-0-1-1group';
%network_config_code = '500-1-0-0-10groups-het';
%network_config_code = '500-1-0-1-2groups-het';
%network_config_code = '500-1-0-0-10groups-het';
...
%rho_vec = [0.006 0.0055 0.005 0.0045 0.004 0.0035 0.003 0.0025 0.002];
%rho_vec = [0.0055 0.006];
%rho_vec = [0.0005 0.001 0.0015 0.002 0.0036];
rho_vec = [0.0005 0.001 0.0015 0.002 0.0025 0.003 0.0035 0.004 0.0045 0.0055];
%network_config_code = '2-1-0-0-1group';
%network_config_code = '3-1-0-0-1group';
%network_config_code = '10-1-0-0-1group';
...
%rho_vec = [0.006 0.0055 0.005 0.0045 0.004 0.0035 0.003 0.0025 0.002];
%rho_vec = [0.0055 0.006];
%rho_vec = [0.0005 0.001 0.0015 0.002 0.0025 0.003 0.0036];
rho_vec = [0.0005 0.001 0.0015 0.002 0.0025 0.003 0.0035 0.004 0.0045 0.0055];
%network_config_code = '2-1-0-0-1group';
%network_config_code = '3-1-0-0-1group';
%network_config_code = '10-1-0-0-1group';
